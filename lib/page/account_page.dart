  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
        ...
        body: new DefaultTabController(
            ...
            child: new Column(
              children: <Widget>[
                new WidgetDecoration(Image.asset(AppIcons.ICON_LOGIN_TITLE, height: 40))
                    ...
                    children: <Widget>[
                      ...
                      new Row(
                        children: <Widget>[
                          ...
                          )).opacity(opacity: currentIndex == 0 ? 1 : 0).align().expanded().build(),
                          new WidgetDecoration(new Container(
                            color: Colors.blue.shade700,
                            height: 2,
                            width: double.infinity,
                          )).opacity(opacity: currentIndex == 1 ? 1 : 0).align().expanded().build(),
                        ],
                      ),
                      new Divider(
                        height: 1,
